...
//
//     final drivingResponse = drivingResponseFromMap(jsonString);
...
class DrivingResponse {
    ...
    factory DrivingResponse.fromJson(String str) => DrivingResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory DrivingResponse.fromMap(Map<String, dynamic> json) => DrivingResponse(
